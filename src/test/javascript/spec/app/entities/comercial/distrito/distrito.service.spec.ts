...
describe('Service Tests', () => {
  describe('Distrito Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Distrito(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Distrito', async () => {
      ...
      it('should update a Distrito', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            ubigeo: 'BBBBBB',
      ...
      it('should return a list of Distrito', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            ubigeo: 'BBBBBB',
      ...
      it('should delete a Distrito', async () => {
