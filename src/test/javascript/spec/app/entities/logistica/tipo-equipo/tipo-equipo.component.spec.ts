...
import { TipoEquipoComponent } from 'app/entities/logistica/tipo-equipo/tipo-equipo.component';
...
describe('Component Tests', () => {
  describe('TipoEquipo Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tipoEquipos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
