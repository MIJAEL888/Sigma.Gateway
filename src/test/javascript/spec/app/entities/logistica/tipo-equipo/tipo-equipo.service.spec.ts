...
describe('Service Tests', () => {
  describe('TipoEquipo Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new TipoEquipo(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a TipoEquipo', async () => {
      ...
      it('should update a TipoEquipo', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            codigo: 'BBBBBB',
      ...
      it('should return a list of TipoEquipo', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            codigo: 'BBBBBB',
      ...
      it('should delete a TipoEquipo', async () => {
