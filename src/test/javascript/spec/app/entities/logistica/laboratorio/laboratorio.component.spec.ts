...
import { LaboratorioComponent } from 'app/entities/logistica/laboratorio/laboratorio.component';
...
describe('Component Tests', () => {
  describe('Laboratorio Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.laboratorios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
