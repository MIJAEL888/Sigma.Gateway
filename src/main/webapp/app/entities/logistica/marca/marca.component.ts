...
export class MarcaComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.marcaService
      ...
      .subscribe(
        (res: HttpResponse<IMarca[]>) => this.paginateMarcas(res.body, res.headers),
  ...
  registerChangeInMarcas() {
    this.eventSubscriber = this.eventManager.subscribe('marcaListModification', response => this.reset());
  }
  ...
  protected paginateMarcas(data: IMarca[], headers: HttpHeaders) {
