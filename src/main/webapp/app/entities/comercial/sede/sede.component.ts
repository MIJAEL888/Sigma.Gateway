...
export class SedeComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.sedeService
      ...
      .subscribe(
        (res: HttpResponse<ISede[]>) => this.paginateSedes(res.body, res.headers),
  ...
  registerChangeInSedes() {
    this.eventSubscriber = this.eventManager.subscribe('sedeListModification', response => this.loadAll());
  }
